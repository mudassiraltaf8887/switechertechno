        ...
        <form action="{{ route('managerlead.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="lead_source">
                            ...
                            <option value="Google Ads" {{ $lead->lead_source == 'Google Ads' ? 'selected' : '' }}>Google Ads</option>
                            <option value="Olx" {{ $lead->lead_source == 'Olx' ? 'selected' : '' }}>Olx</option>
                            <option value="Reference" {{ $lead->lead_source == 'Reference' ? 'selected' : '' }}>Reference</option>
                            <option value="Youtube" {{ $lead->lead_source == 'Youtube' ? 'selected' : '' }}>Youtube</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="lead_for">
                            ...
                            <option value="ERP Software" {{ $lead->lead_for == 'ERP Software' ? 'selected' : '' }}>ERP Software</option>
                            ...
                            <option value="POS Software" {{ $lead->lead_for == 'POS Software' ? 'selected' : '' }}>POS Software</option>
            ...
            <div class="manager-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="manager_remarks" rows="3" placeholder="Manager's notes..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-success btn-lg me-3">
                    <i class="fas fa-save"></i> Save to Manager Lead
                </button>
